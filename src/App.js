...
const Planet = (props) => {
  ...
  return (
    <>
      <div className="card">
        {/* <img src={require("./img/neptune.jpg").default} alt={props.name} /> */}
        ...
        <ul>
          <li>
            <strong>Diameter: {props.diameter}</strong>
          </li>
          <li>
            <strong>Moons:{props.moons}</strong>
          </li>
        </ul>
...
function AppContainer() {
  ...
  const handleDelete = (planetId) => {
    setPlanetList((prevPlanetList) =>
      prevPlanetList.filter((planet) => planet.id !== planetId)
    );
  };
